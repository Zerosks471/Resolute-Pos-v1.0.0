...
exports.addMenuItem = async (req, res) => {
    try {
        ...
        const menuItemId = await addMenuItemDB(title, price, netPrice, taxId, categoryId, null);
...
exports.updateMenuItem = async (req, res) => {
    try {
        ...
        await updateMenuItemDB(id, title, price, netPrice, taxId, categoryId, null);
...
exports.addMenuItemAddon = async (req, res) => {
    try {
        ...
        const menuItemAddonId = await addMenuItemAddonDB(itemId, title, price);
...
exports.updateMenuItemAddon = async (req, res) => {
    try {
        ...
        await updateMenuItemAddonDB(itemId, addonId, title, price);
...
exports.addMenuItemVariant = async (req, res) => {
    try {
        ...
        const menuItemVariantId = await addMenuItemVariantDB(itemId, title, price);
...
exports.updateMenuItemVariant = async (req, res) => {
    try {
        ...
        await updateMenuItemVariantDB(itemId, variantId, title, price);
