...
exports.completeKitchenOrder = async (req, res) => {
  try {
    ...
    await completeOrderDB(orderIds);
...
exports.getOrdersPaymentSummary = async (req, res) => {
  try {
    ...
    const {kitchenOrders,kitchenOrdersItems,addons} = await getOrdersPaymentSummaryDB(orderIdsParams);
