...
exports.addUser = async (req, res) => {
    try {
        ...
        // 3. create user
        await addUserDB(username, encryptedPassword, name, role, null, designation, phone, email, userScopes.join(","));
...
exports.updateUser = async (req, res) => {
    try {
        ...
        await deleteUserRefreshTokensDB(username);
        await updateUserDB(username, name, null, designation, phone, email, userScopes.join(","));
...
exports.updateUserPassword = async (req, res) => {
    try {
        ...
        await deleteUserRefreshTokensDB(username);
        await updateUserPasswordDB(username, encryptedPassword);
