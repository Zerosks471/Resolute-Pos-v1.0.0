...
export default function ReservationCard({
  ...
  return (
    <div
      key={unique_code}
      className="text-resolute-text border border-resolute-border-light rounded-2xl p-4 flex gap-4 items-center"
    >
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center gap-4 text-sm text-resolute-text">
