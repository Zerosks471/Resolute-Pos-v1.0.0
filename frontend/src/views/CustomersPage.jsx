    ...
    <Page>
      <div className="flex flex-wrap gap-4 flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={btnSearch} className="text-resolute-text bg-resolute-primary transition hover:bg-resolute-primary/80 active:scale-95 rounded-lg px-4 py-1 outline-resolute-border-light">
            Search
          </button>
        </div>
      </div>
      ...
      
      {
        customers?.length > 0 && <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4">
        {
          customers.map((customer, index)=>{
            ...
            return (<div key={phone} className="border border-resolute-border-light rounded-2xl px-4 py-5">
      ...
      <div className="modal-box">
        ...
        <div className="mt-4">
          ...
          <input
            ...
            name="phone"
            disabled
            className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 disabled:text-gray-400 outline-resolute-border-light cursor-not-allowed"
        ...
        <div className="modal-action">
          <form method="dialog">
            ...
            <button
              ...
              className="rounded-lg hover:bg-amber-800 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-resolute-primary text-resolute-text ml-3"
            >
              Save
            </button>
          </form>
