  ...
  return (
    <Page>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        ...
        {/* reservation */}
        <div className='border border-resolute-border-light rounded-3xl h-96 overflow-y-auto'>
        ...
        <div className="flex flex-col gap-6">
          {/* items sold */}
        <div className='border border-resolute-border-light rounded-3xl h-28 py-5 px-6'>
        ...
        <Link to="/dashboard/reports" className='block rounded-3xl py-5 px-6 hover:bg-gray-50 transition active:scale-95 border border-resolute-border-light text-resolute-text bg-[url(/assets/circle_illustration.svg)] bg-no-repeat bg-right-bottom'>
