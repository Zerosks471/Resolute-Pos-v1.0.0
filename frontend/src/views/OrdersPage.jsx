...
export default function OrdersPage() {
  ...
  const sendOrderUpdateEvent = () => {
    if (isSocketConnected) {
      socket.emit("order_update_backend");
    } else {
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4">
          {kitchenOrders.map((order, index) => {
            ...
            return (
              <div
                key={index}
                className="border border-resolute-border-light rounded-2xl px-4 py-5 flex flex-col divide-y divide-dashed"
              >
                            ...
                            >
                              ...
                              <div className="dropdown dropdown-left">
                                ...
                                >
                                  ...
                                  <li>
                                    <button
                                      className="flex items-center gap-2 bg-transparent border-none shadow-none text-resolute-primary"
                                      onClick={() => {
                                        btnChangeOrderItemStatus(
                                          orderItemId,
                                          "completed"
          ...
          <div className="modal-action">
            <form method="dialog">
              ...
              <button
                ...
                className="ml-2 btn hover:bg-amber-500 bg-resolute-primary text-resolute-text"
              >
                Yes Confirm!
              </button>
            </form>
        ...
        <div className="modal-box">
          ...
          <div className="py-4">
            <div className="flex w-full items-center divide-x gap-x-4">
              ...
              <div className="flex-1 pl-4">
                <p>Total</p>
                <p className="text-2xl text-resolute-primary font-bold">
                  {currency}
