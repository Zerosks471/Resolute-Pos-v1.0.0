...
export default function ProfilePage() {
  ...
  const {name, designation, photo} = user;
  ...
  return (
    <Page>
      ...
      <div className="flex w-full items-center justify-center mt-8">
        <div className="w-full md:w-96 rounded-3xl border border-gray-100">
          <div className="w-full h-20 rounded-3xl p-2 bg-resolute-primary relative">
