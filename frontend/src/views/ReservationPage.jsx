            ...
            <div className="flex gap-2 mt-4">
              <div className="flex-1">
                ...
                <input
                  ...
                  type="date"
                  ref={fromDateRef}
                  className="text-sm w-full border rounded-lg px-4 py-1 bg-gray-50 outline-resolute-border-light"
                />
              </div>
              <div className="flex-1">
                <label
        ...
        <div className="modal-box">
          ...
          <div className="my-4">
            ...
            <textarea
              ...
              className="w-full block h-24 text-sm border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light"
            ></textarea>
          </div>
