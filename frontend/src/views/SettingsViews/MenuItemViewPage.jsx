...
import { addMenuItemAddon, addMenuItemVariant, deleteMenuItemAddon, deleteMenuItemVariant, updateMenuItem, updateMenuItemAddon, updateMenuItemVariant, useMenuItem } from "../../controllers/menu_item.controller";
  ...
  return (
    <Page className="px-4 md:px-8 py-3 md:py-6">
      ...
      <div className="my-6 flex gap-6 flex-col lg:flex-row">
        <div className="">
          <div className="w-32 h-32 md:w-64 md:h-64 bg-gray-200 rounded-2xl flex items-center justify-center text-gray-600 text-2xl mb-4">
            {title}
          </div>
          <p>Price: {price}</p>
          {net_price && (
          ...
          <button onClick={btnSave} className="mt-6 text-resolute-text w-full bg-resolute-primary transition hover:bg-amber-500 active:scale-95 rounded-lg px-4 py-2 outline-resolute-border-light">Save</button>
        </div>
        <div className="flex-1">
          <div className="">
            ...
            <input
              ...
              type="text"
              name="title"
              className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light"
      ...
      <dialog id="modal-add-variant" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="mt-4">
            ...
            <input ref={variantTitleRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Variant Title" />
          </div>

          <div className="my-4">
            <label htmlFor="price" className="mb-1 block text-gray-500 text-sm">Variant Price</label>
            <input ref={variantPriceRef} type="number" name="price" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Variant Price" />
          ...
          <div className="modal-action">
            <form method="dialog">
              ...
              <button onClick={()=>{btnAddVariant();}} className="rounded-lg hover:bg-amber-500 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-resolute-primary text-resolute-text ml-3">Save</button>
            </form>
          </div>
        </div>
      </dialog>
      ...
      <dialog id="modal-update-variant" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="mt-4">
            ...
            <label htmlFor="title" className="mb-1 block text-gray-500 text-sm">Variant Title</label>
            <input ref={variantTitleUpdateRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Variant Title" />
          </div>

          <div className="my-4">
            <label htmlFor="price" className="mb-1 block text-gray-500 text-sm">Variant Price</label>
            <input ref={variantPriceUpdateRef} type="number" name="price" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Variant Price" />
          ...
          <div className="modal-action">
            <form method="dialog">
              {/* if there is a button in form, it will close the modal */}
              <button className="rounded-lg hover:bg-gray-200 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-gray-200 text-gray-500">Close</button>
              <button onClick={()=>{btnUpdateVariant();}} className="rounded-lg hover:bg-amber-500 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-resolute-primary text-resolute-text ml-3">Save</button>
            </form>
          </div>
        </div>
      </dialog>
      ...
      <dialog id="modal-add-addon" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="mt-4">
            ...
            <input ref={addonTitleRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Addon Title" />
          </div>

          <div className="my-4">
            <label htmlFor="price" className="mb-1 block text-gray-500 text-sm">Addon Price</label>
            <input ref={addonPriceRef} type="number" name="price" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Addon Price" />
          ...
          <div className="modal-action">
            <form method="dialog">
              {/* if there is a button in form, it will close the modal */}
              <button className="rounded-lg hover:bg-gray-200 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-gray-200 text-gray-500">Close</button>
              <button onClick={()=>{btnAddAddon();}} className="rounded-lg hover:bg-amber-500 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-resolute-primary text-resolute-text ml-3">Save</button>
            </form>
          </div>
        </div>
      </dialog>
      ...
      <dialog id="modal-update-addon" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="mt-4">
            ...
            <label htmlFor="title" className="mb-1 block text-gray-500 text-sm">Addon Title</label>
            <input ref={addonTitleUpdateRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Addon Title" />
          </div>

          <div className="my-4">
            <label htmlFor="price" className="mb-1 block text-gray-500 text-sm">Addon Price</label>
            <input ref={addonPriceUpdateRef} type="number" name="price" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Addon Price" />
          ...
          <div className="modal-action">
            <form method="dialog">
              {/* if there is a button in form, it will close the modal */}
              <button className="rounded-lg hover:bg-gray-200 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-gray-200 text-gray-500">Close</button>
              <button onClick={()=>{btnUpdateAddon();}} className="rounded-lg hover:bg-amber-500 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-resolute-primary text-resolute-text ml-3">Save</button>
            </form>
          </div>
        </div>
      </dialog>
