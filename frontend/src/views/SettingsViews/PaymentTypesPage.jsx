                ...
                <tr key={id}>
                  ...
                  <td className="px-3 py-2 text-start flex flex-wrap gap-2 items-center">
                    ...
                    <label className="relative flex items-center cursor-pointer no-drag">
                      ...
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-gray-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:bg-resolute-primary peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600"></div>
                    </label>
                    {/* switch */}
                  </td>
                </tr>
      ...
      <dialog id="modal-add" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="my-4">
            ...
            <input ref={paymentTypeAddRef} type="text" name="paymentType" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Payment Type" />
          </div>
      ...
      <dialog id="modal-update" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="mt-4">
            ...
            <input ref={paymentTypeTitleUpdateRef} type="text" name="paymentTypeUpdate" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Payment Type" />
          </div>
