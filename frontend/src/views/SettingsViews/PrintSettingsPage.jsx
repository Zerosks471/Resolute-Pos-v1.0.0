      ...
      <div className="mt-8 text-gray-500 text-sm">
        ...
        <div className="mt-4 w-full lg:min-w-96">
          ...
          <select
            ...
            name="pageSize"
            id="pageSize"
            className="block w-full border rounded-lg px-4 py-2 bg-gray-50 text-gray-500 outline-resolute-border-light"
          >
            <option hidden value="">
              Select Page Size
            </option>
        ...
        <div className="mt-4">
          ...
          <textarea
            ...
            className="block w-full h-20 lg:min-w-96 border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light"
          />
        </div>
        ...
        <button
          onClick={btnSave}
          className="text-resolute-text w-full lg:min-w-96 bg-resolute-primary transition hover:bg-amber-500 active:scale-95 rounded-lg px-4 py-2 mt-6 outline-resolute-border-light"
        >
          Save
        </button>
      </div>
