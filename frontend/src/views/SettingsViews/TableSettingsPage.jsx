...
import { addNewStoreTable, deleteTable, updateStoreTable, useStoreTables } from "../../controllers/settings.controller";
    ...
    <Page className="px-8 py-6">
      ...
      <div className="mt-8 w-full grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
        {storeTables.map((storeTable, index) => {
          const { id, table_title, seating_capacity, floor } = storeTable;

          return (
            <div
              key={id}
              className="border px-4 py-3 rounded-2xl flex items-center gap-2 text-sm"
            >
      ...
      <dialog id="modal-add" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="mt-4">
            ...
            <input ref={tableTitleRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Table Title" />
          </div>

          <div className="flex gap-4 w-full my-4">
            <div className="flex-1">
              <label htmlFor="floor" className="mb-1 block text-gray-500 text-sm">Floor</label>
              <input ref={tableFloorRef} type="text" name="floor" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Floor Title" />
            </div>
            <div className="flex-1">
              <label htmlFor="capacity" className="mb-1 block text-gray-500 text-sm">Seating Capacity</label>
              <input ref={tableSeatingCapacityRef} type="number" name="capacity" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Seating Capcity" />
            </div>
          </div>
          ...
          <div className="modal-action">
            <form method="dialog">
              ...
              <button onClick={()=>{btnAdd();}} className="rounded-lg hover:bg-amber-500 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-resolute-primary text-resolute-text ml-3">Save</button>
            </form>
          </div>
        </div>
      </dialog>
      ...
      <dialog id="modal-update" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="mt-4">
            ...
            <label htmlFor="title" className="mb-1 block text-gray-500 text-sm">Title</label>
            <input ref={tableTitleUpdateRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Table Title" />
          </div>

          <div className="flex gap-4 w-full my-4">
            <div className="flex-1">
              <label htmlFor="floor" className="mb-1 block text-gray-500 text-sm">Floor</label>
              <input ref={tableFloorUpdateRef} type="text" name="floor" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Floor Title" />
            </div>
            <div className="flex-1">
              <label htmlFor="capacity" className="mb-1 block text-gray-500 text-sm">Seating Capacity</label>
              <input ref={tableSeatingCapacityUpdateRef} type="number" name="capacity" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Seating Capcity" />
            </div>
          </div>
          ...
          <div className="modal-action">
            <form method="dialog">
              {/* if there is a button in form, it will close the modal */}
              <button className="rounded-lg hover:bg-gray-200 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-gray-200 text-gray-500">Close</button>
              <button onClick={()=>{btnUpdate();}} className="rounded-lg hover:bg-amber-500 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-resolute-primary text-resolute-text ml-3">Save</button>
            </form>
          </div>
