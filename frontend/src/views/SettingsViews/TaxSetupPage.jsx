        ...
        <table className="w-full border overflow-x-auto">
          ...
          <tbody>
            {taxes.map((tax, index) => {
              ...
              return (
                <tr key={id}>
                  <td className="px-3 py-2 text-start">{id}</td>
      ...
      <dialog id="modal-add" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="mt-4">
            ...
            <input ref={taxTitleAddRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Tax Title" />
          </div>

          <div className="flex gap-4 w-full my-4">
            <div className="flex-1">
              <label htmlFor="rate" className="mb-1 block text-gray-500 text-sm">Rate</label>
              <input ref={taxRateAddRef} type="number" name="rate" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Tax Rate" />
            </div>
            <div className="flex-1">
              <label htmlFor="type" className="mb-1 block text-gray-500 text-sm">Type</label>
              <select ref={taxTypeAddRef} name="type" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Select Tax Type" >
      ...
      <dialog id="modal-update" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="mt-4">
            ...
            <label htmlFor="title" className="mb-1 block text-gray-500 text-sm">Title</label>
            <input ref={taxTitleUpdateRef} type="text" name="title" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Tax Title" />
          </div>

          <div className="flex gap-4 w-full my-4">
            <div className="flex-1">
              <label htmlFor="rate" className="mb-1 block text-gray-500 text-sm">Rate</label>
              <input ref={taxRateUpdateRef} type="number" name="rate" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Enter Tax Rate" />
            </div>
            <div className="flex-1">
              <label htmlFor="type" className="mb-1 block text-gray-500 text-sm">Type</label>
              <select ref={taxTypeUpdateRef} name="type" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light" placeholder="Select Tax Type" >
                <option value="" hidden>Select Tax Type</option>
                <option value="exclusive">Exclusive</option>
                <option value="inclusive">Inclusive</option>
              </select>
