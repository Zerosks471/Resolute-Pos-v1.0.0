...
export default function UsersPage() {
  ...
  const btnShowUpdate = (username, name, phone, email, designation, scope) => {
    ...
    emailUpdateRef.current.value = email;
  ...
  const btnUpdate = async () => {
    ...
    const email = emailUpdateRef.current.value;
    ...
    try {
      ...
      const res = await updateUser(
        username,
        name, designation, phone, email, userScopes
      );
      ...
      if (res.status == 200) {
        ...
        emailUpdateRef.current.value = null;
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4">
        {users.map((user, index) => {
          ...
          return (
            <div
              key={index}
              className="border border-resolute-border-light rounded-2xl px-4 py-5 flex flex-col"
            >
              <div className="flex-1">
                <div className="flex items-center flex-col text-center gap-2">
                  ...
                  <div>
                    ...
                    {designation && <p className="text-xs text-resolute-text bg-resolute-primary rounded-full w-fit px-2 mx-auto mt-1">{designation}</p>}
                  </div>
              ...
              {role != "admin" && (
                <div className="flex flex-wrap gap-2 mt-4">
                  <button
                    onClick={() => {
                      btnShowUpdate(username, name, phone, email, designation, scope);
                    }}
          ...
          <div className="modal-action mt-4">
            <form method="dialog">
              ...
              <button
                ...
                className="rounded-lg hover:bg-amber-500 transition active:scale-95 hover:shadow-lg px-4 py-3 bg-resolute-primary text-resolute-text ml-3"
              >
                Save
              </button>
            </form>
        ...
        <div className="modal-box">
          ...
          <div className="mt-4">
              ...
              <input
                ...
                type="text"
                name="username"
                className=" cursor-not-allowed disabled:bg-gray-200 text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-resolute-border-light"
                placeholder="Enter Username here..."
              />
            </div>
